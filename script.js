const pages=[...document.querySelectorAll('.page')];
    ...
    const details={
      ...
      atanu:{title:'ধনঞ্জয় বর্মণ — Assistant Teacher',body:'<p>বিষয়ভিত্তিক সহায়তা, নিয়মিত অনুশীলন এবং দুর্বল শিক্ষার্থীদের বিশেষ যত্নের মাধ্যমে শিক্ষার্থীদের অগ্রগতি নিশ্চিত করেন।</p><ul><li>দৈনিক অনুশীলন ও সন্দেহ নিরসন</li><li>ক্লাস টেস্ট প্রস্তুতি</li><li>সহজ ভাষায় বিষয় ব্যাখ্যা</li></ul>'},
      raj:{title:'রফিকুল হক — Assistant Teacher',body:'<p>সহজ ভাষায় পড়ানো, নিয়মিত মূল্যায়ন এবং স্টাডি ম্যাটেরিয়ালের মাধ্যমে শিক্ষার্থীদের শেখার পথকে আরও কার্যকর করে তোলেন।</p><ul><li>স্টাডি ম্যাটেরিয়াল সহায়তা</li><li>নিয়মিত রিভিশন</li><li>বোর্ড প্রস্তুতির গাইডলাইন</li></ul>'}
    };
